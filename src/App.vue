      ...
      <el-header>
        ...
        <el-menu :default-active="activeIndex" :default-openeds="['1']" router mode="horizontal" :ellipsis="false"
          ...
          <el-sub-menu index="0">
            ...
            <el-menu-item index="zh" @click="changeLanguage('zh')"><i class="fi fi-cn"></i> &nbsp; 中文</el-menu-item>
            <el-menu-item index="en" @click="changeLanguage('en')"><i class="fi fi-us"></i> &nbsp; English</el-menu-item>
          </el-sub-menu>
...
const openGitHub = () => {
  window.open('https://github.com/secs/tools', '_blank', 'noopener,noreferrer');
};
